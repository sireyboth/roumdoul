<div>
  ...
  <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-10 lg:grid-cols-2">
      <div>
        <div class="flex aspect-4/3 items-center justify-center rounded-3xl bg-linear-to-br from-brand-100 to-brand-200 text-brand-700 dark:from-plum-800 dark:to-plum-950 dark:text-brand-300">
          <x-icon name="{{ $service->category->icon }}" class="h-28 w-28" />
        </div>
      </div>
      ...
      <div>
        @if ($service->is_featured)
          <span class="mb-3 inline-flex items-center gap-1 rounded-full bg-gold-500 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-brand-950">
            <x-icon name="star" class="h-3 w-3" /> Featured
          </span>
        @endif
